...
int test_str_copy()
{
	...
	char* s2 = str_copy("amount");
	if (strcmp(s2, "amount") != 0)
	{
...
{
	char* s0 = trim_prefix("aaadasdsa", "aaac");
	if (strcmp(s0, "aaadasdsa") != 0)
	{
		g_free(to_void_ptr(&s0));
		return TEST_FAIL;
	}
	...
	char* s3 = trim_prefix("aaadasdsa", "a");
	if (strcmp(s3, "dasdsa") != 0)
	{
		g_free(to_void_ptr(&s3));
		return TEST_FAIL;
	}
	...
	char* s4 = trim_prefix("aaadasdsa", "aa");
	if (strcmp(s4, "adasdsa") != 0)
	{
		g_free(to_void_ptr(&s4));
		return TEST_FAIL;
	}
	...
	char* s5 = trim_prefix("aaadasdsa", "aaa");
	if (strcmp(s5, "dasdsa") != 0)
	{
		g_free(to_void_ptr(&s5));
		return TEST_FAIL;
	}
	...
	char* s6 = trim_prefix("aaaaaaaadasdsa", "aaa");
	if (strcmp(s6, "aadasdsa") != 0)
	{
	...
	char* s7 = trim_prefix("你好啊你好啊今天是你好啊个好日子", "你好啊");
	if (strcmp(s7, "今天是你好啊个好日子") != 0)
	{
...
int test_trim_suffix()
{
	...
	char* s3 = trim_suffix("aaadasdsadsa", "dsa");
	if (strcmp(s3, "aaadas") != 0)
	{
		g_free(to_void_ptr(&s3));
		return TEST_FAIL;
	}
	...
	char* s4 = trim_suffix("aaadasdsa       ", " ");
	if (strcmp(s4, "aaadasdsa") != 0)
	{
		g_free(to_void_ptr(&s4));
		return TEST_FAIL;
	}
...
int test_pick_str_until()
{
	...
	char* s2 = pick_str_until("abcdefghijklmn\n\raddasd\n9adasd", '\n', true);
	if (strcmp(s2, "abcdefghijklmn\n") != 0)
	{
		g_free(to_void_ptr(&s2));
		return TEST_FAIL;
	}
